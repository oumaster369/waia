...
import {
  DASHBOARD_TAB_ORDER,
  dashboardE2EForbiddenPhraseRegex,
...
async function expectNoForbiddenPhrases(page: Page): Promise<void> {
...
async function expectTabsMatchPresentations(
  page: Page,
...
async function assertDashboardMatrix(
  ...
  await expectNoForbiddenPhrases(page);
  await expectTabsMatchPresentations(page, pres);
}
