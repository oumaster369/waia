...
describe("trader admin page admission", () => {
  ...
  it("does not fail open when authorization throws", async () => {
    ...
    await expect(TraderAdminLayout({ children: "protected" })).rejects.toThrow(
