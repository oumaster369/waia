...
export const HOMEPAGE_COPY = {
  ...
  breath: {
    ...
    runwayLabel: "Runway",
    runwayTitle: "WAIA Runway",
    runwayNow: "NOW",
    runwayEnd: "RUNWAY END",
    runwayEndPending: "RUNWAY",
    runwayPendingValue: "Runway awaiting first ledger publication",
    runwayPendingNote: "The first live runway will appear with the Breath ledger.",
    runwayPublishedNote: "Remaining operating time for the open WAIA project.",
