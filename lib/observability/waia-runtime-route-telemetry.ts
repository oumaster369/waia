...
export type WaiaRuntimeRouteKey =
  ...
  | "trader_admin_console_stream"
  | "trader_admin_console_time"
  ...
  | "trader_admin_console_context"
  | "trader_admin_console_market"
  | "trader_admin_console_news"
  | "trader_admin_console_cycles"
  | "trader_admin_console_kill_switch"
  | "trader_admin_console_orders"
  | "trader_admin_console_aggregate"
  | "trader_admin_console_clients"
  | "trader_admin_console_invoices"
  | "trader_admin_console_invoice_detail"
  | "trader_admin_console_reporting_periods"
  ...
  | "trader_admin_console_promotions"
  | "trader_admin_console_promotion_commands"
  | "trader_admin_console_accounts"
  | "trader_admin_console_incidents"
  | "trader_admin_console_system"
  | "trader_admin_console_assistant_help"
  | "trader_admin_console_assistant_quick_answers"
  | "trader_admin_console_assistant_conversations"
  | "trader_admin_console_assistant_conversation"
  | "trader_admin_console_assistant_messages"
  | "trader_admin_console_assistant_message_trace"
  | "trader_admin_console_payments"
  | "trader_admin_console_disputes"
  | "trader_admin_console_export"
  | "trader_admin_console_proposals"
  | "trader_admin_console_cycle_trace"
  | "trader_admin_console_order_detail"
  | "trader_admin_console_account_detail"
  | "trader_admin_console_client_history"
  | "trader_admin_console_fills"
  | "trader_admin_console_closed_trades"
  | "trader_admin_console_positions"
  | "trader_admin_console_attention"
  ...
  | "trader_admin_reporting_periods"
  ...
  | "trader_admin_connected_accounts"
  | "trader_admin_fleet_portfolio"
  | "trader_admin_fhv_operations_status"
  | "trader_admin_fhv_operations_commands"
  | "trader_admin_fhv_operations_detail"
  | "trader_admin_historical_v2_launch"
  | "trader_admin_historical_v2_ratification_get"
  | "trader_admin_historical_v2_ratification_post"
  ...
  | "admin_treasury_balance_checkpoints"
