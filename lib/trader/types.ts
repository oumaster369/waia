...
export const traderAuditActions = {
  ...
  positionSnapshotCreated: "trader.position_snapshot.created",
  tradeHistorySnapshotCreated: "trader.trade_history_snapshot.created",
  ...
  invoiceDisputeOpened: "trader.invoice_dispute.opened",
  invoiceDisputeResolvedUpheld: "trader.invoice_dispute.resolved_upheld",
  invoiceDisputeResolvedCorrected: "trader.invoice_dispute.resolved_corrected",
  invoiceCorrectionApplied: "trader.invoice_correction.applied",
  ...
  orgLiveEnableRequested: "trader.org_live_enable.requested",
  orgLiveEnableConfirmed: "trader.org_live_enable.confirmed",
  orgLiveEnableEnabled: "trader.org_live_enable.enabled",
  orgLiveEnableDisabled: "trader.org_live_enable.disabled",
  orgLiveEnableCancelled: "trader.org_live_enable.cancelled",
...
export const traderEntityTypes = {
  ...
  tradeHistorySnapshot: "trader.trade_history_snapshot",
  reportingPeriod: "trader.reporting_period",
  hwmLedger: "trader.hwm_ledger",
  invoice: "trader.invoice",
  invoiceDispute: "trader.invoice_dispute",
  invoiceCorrection: "trader.invoice_correction",
  ...
  orgLiveEnable: "trader.org_live_enable",
