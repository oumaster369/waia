export const ADMIN_REASON = {
  ...
  guardianAssessmentMissing: "GUARDIAN_ASSESSMENT_MISSING",
  guardianAssessmentStale: "GUARDIAN_ASSESSMENT_STALE",
  riskAccountUnmatched: "RISK_ACCOUNT_UNMATCHED",
  riskPostureUnknown: "RISK_POSTURE_UNKNOWN",
  lotQtyInconsistent: "LOT_QTY_INCONSISTENT",
