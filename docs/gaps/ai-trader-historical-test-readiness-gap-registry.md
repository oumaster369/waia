...
| HTR-GAP-002 | Reconstruction full recompute | blocker | open (2026-07-13; WP08 WORK COMMIT 0c4b8c3 delivered acyclic reconstruction leaf kernel, shared six-block assembly + production content-digest, true affected-state incremental reconstruction with bounded swing/sweep/ATR/session/prior-day state, streaming Wilder ATR + 16-value delay ring, exact closed-boundary oracle parity 22/22 with 0 divergences and FULL_HISTORY_RESCANS 0, deterministic restart; no runtime cutover; closure remains HTR-WP09) | HTR-WP08 | — | HTR-WP09 | IB-HTR-08 |
