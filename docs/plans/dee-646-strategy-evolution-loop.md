...
state:
  ...
  blockedReason: null
  nextAction: "Remaining research-only loop WPs after DEE-1028 are owned by DEE-1029 (docs/plans/dee-1029-human-assignment-research-job-isolation.md). Keep this parent In Progress."
provenance:
  createdFrom: chat
  gapRegistry: null
  supersedes: null
