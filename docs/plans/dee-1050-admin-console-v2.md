...
2. **Замер накладных расходов** — `tests/integration/admin-console-change-log-overhead-postgres.test.ts`.
   ...
   - Локальный прогон на изолированном `postgres:16` (триггеры сначала, затем без них), 2026-09-24: p95 порог 5.878 мс / факт 4.671 мс / ok; p99 факт 6.333 мс; WAL порог 10136422 байт / факт 7448368 байт / ok; CI p95 порог 9.757 мс / факт 4.671 мс / ok; CI WAL порог 15594496 байт / факт 7448368 байт / ok. База без триггеров: p95 4.878 мс, p99 7.347 мс, WAL 7797248 байт. CI печатает свою таблицу заново.
