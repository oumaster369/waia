...
state:
  status: in-progress
  humanApproval: PENDING_REVIEW_FINAL_D2_PROFILE_MATRIX_MIGRATION_AND_MACRO_E_PACKET   # 2026-07-14: Macro-E final packet hardened (this governance session, AUTHORIZE-HTR-MACRO-E-FINAL-PACKET-HARDENING, CONSUMED, no build/PR); packet internally exact and awaiting Human final decision. HISTORICAL/CONSUMED authorizations: AUTHORIZE_OPUS_MACRO_D_PHASE_B (Macro-D Phase B post-review + WP11 f6cefb0 / WP12 993fdab closeout); AUTHORIZE-HTR-WP13-WP16-INTELLIGENCE-TRANCHE-PLANNING; AUTHORIZE-HTR-MACRO-E-FINAL-PREAPPROVAL-RECONCILIATION; AUTHORIZE_FINAL_OPUS_WP10_EVIDENCE_HERMETICITY_REREVIEW (WP10 FINAL_PHASE_B_PASS, closeout b132166).
  childPlanStatus: CONFIRM_REQUIRED   # 2026-07-14 Macro-E final packet hardening: active child controller = .cursor/plans/dee-415-htr-wp13-wp16-intelligence-rolling.plan.md (HTR-MACRO-E CONFIRM_REQUIRED / WP13 MIGRATION CONFIRM_REQUIRED_WITH_EXACT_PACKAGE); Build NOT authorized; MACRO_E_READINESS READY_FOR_HUMAN_MACRO_E_FINAL_DECISION (WP10 evidence-hermeticity closed FINAL_PHASE_B_PASS b132166; packet internally exact)
  programStatus: APPROVED_IDLE   # 2026-07-14: HTR-MACRO-D COMPLETE (Opus Phase B per-WP PASS); WP04–WP12 rolling tranche COMPLETE; WP13–WP16 intelligence tranche PLANNED + Macro-E final packet hardened + internally exact; WP10 evidence-hermeticity closed FINAL_PHASE_B_PASS (b132166); awaiting Human APPROVE_FINAL_D2_D3_MATRIX_MIGRATION_STRATEGY_FOUNDATION_AND_MACRO_E_PACKET gate
  governanceStateAuthority: GIT_HEAD   # a tracked document cannot safely record the SHA of the commit that contains itself; the authoritative governance head is always the current git HEAD of this branch, not a self-referential field
  governanceReconciledFromHead: b132166bb75ecc7e09f8d66b91c8447815d95cb9   # this operational state was reconciled from HEAD b132166 (WP10 evidence-hermeticity closeout); the Macro-E hardening governance commit created atop it advances HEAD by one
  # (former field currentGovernanceHead: 6e2c8d3585ae77c83c477e9f6620bf266de54fbf removed — misleading self-referential SHA; governance head authority is GIT_HEAD)
  ...
  planningTerminalState: MACRO_E_FINAL_PACKET_HARDENING   # 2026-07-14: Macro-E final packet hardened (conviction cardinality resolved to Model B cycle-level active/aggregate; SQLITE_ADAPTER NOT_REQUIRED; strategy-discovery-to-operator foundation contract added); WP10 evidence-hermeticity closed FINAL_PHASE_B_PASS (b132166); ready for final Human Macro-E decision
  ...
  composerTerminalState: WP10_EVIDENCE_HERMETICITY_FINAL_PHASE_B_PASS_CLOSED   # 2026-07-14: WP10 evidence-hermeticity correction closed FINAL_PHASE_B_PASS (closeout b132166); no active Composer Build session. Historical: Composer Phase A delivered WP11 f6cefb0 + WP12 993fdab (Macro-D Phase B post-review PASS + closeouts).
  branch: dee-415-ai-trader-historical-test-readiness
  branchCreated: true
  buildStarted: true
  ...
  intelligenceTranche:
    ...
    wp13MigrationDecision: CONFIRM_REQUIRED_WITH_EXACT_PACKAGE   # 3 append-only Postgres tables (trader_intelligence_cycle_envelope/hypothesis_record/conviction_record); service-role RLS; SQLITE_ADAPTER NOT_REQUIRED (db/AGENTS.md:148 Postgres-only MVP freeze + ADR-0017); conviction cardinality = Model B cycle-level active/aggregate (UNIQUE(org,run,cycle,symbol); active_hypothesis_record_id NULLABLE + conviction_scope ACTIVE_HYPOTHESIS|AGGREGATE|NONE); hypothesis UNIQUE(org,run,cycle,symbol,hypothesis_type); DUP-14 link; migrations 0076–0081; Forecast/Decision/whyNotCash DEFERRED to WP14; no SQL created
    ...
    macroEReadiness: READY_FOR_HUMAN_MACRO_E_FINAL_DECISION   # 2026-07-14: final packet hardened + internally exact (conviction cardinality Model B, SQLITE_ADAPTER NOT_REQUIRED, strategy-discovery foundation contract); WP10 evidence-hermeticity closed. Remaining Macro-E gates (D-2, D-3 profile+matrix, WP13 migration, strategy-discovery contract, exact HTR-MACRO-E packet, Build authorization) awaiting Human final decision — none consumed this session
  ...
  activeMacroStatus: CONFIRM_REQUIRED   # HTR-MACRO-E [HTR-WP13] final packet hardened + internally exact; WP13 MIGRATION CONFIRM_REQUIRED_WITH_EXACT_PACKAGE; Build NOT authorized
  ...
  nextHumanGate: APPROVE_FINAL_D2_D3_MATRIX_MIGRATION_STRATEGY_FOUNDATION_AND_MACRO_E_PACKET   # AUTHORIZE_HTR_WP13_PLANNING_AND_RESOLVE_D1_D2_D3 + AUTHORIZE-HTR-MACRO-E-FINAL-PREAPPROVAL-RECONCILIATION + AUTHORIZE-HTR-MACRO-E-FINAL-PACKET-HARDENING all CONSUMED 2026-07-14; packet now internally exact awaiting Human final decision
  nextAction: "HUMAN_DECIDE_FINAL_MACRO_E_PACKET (Human gate APPROVE_FINAL_D2_D3_MATRIX_MIGRATION_STRATEGY_FOUNDATION_AND_MACRO_E_PACKET). WP10 EVIDENCE-HERMETICITY CLOSED FINAL_PHASE_B_PASS (closeout b132166; correction chain 017fcbe FAIL → f2413b2 FAIL → 521ddd1 PASS; original seal preserved byte-identical; accepted post-Macro-D compatibility evidence promoted to replay-runs/RI-P7/htr-wp10-determinism-nolookahead-post-macro-d/). Macro-E final packet HARDENED + INTERNALLY EXACT 2026-07-14 (controller .cursor/plans/dee-415-htr-wp13-wp16-intelligence-rolling.plan.md; HTR-MACRO-E [WP13] / HTR-MACRO-F [WP14,15] / HTR-MACRO-G [WP16]). D-1 ALREADY_RESOLVED (record-level chain, no mature autonomous engines); D-3 CANON_RESOLVED, exact application FINALIZED (HTR_HISTORICAL_INTELLIGENCE_PROFILE_V1, digest 9a1ed67e…, supersedes draft fac1a44f…, PROPOSED_FINAL not consumed); D-2 PROPOSED_FINAL not consumed (HTX SPOT BTC+ETH; enabled LSR+MR; research-only trend_momentum_v0 = EVIDENCE_ONLY_NOT_TRADE_ELIGIBLE; enablement is NOT SVG approval / NOT an edge verdict; version-pin+lifecycle owned by WP16); TIMEFRAME_EVIDENCE_LANE_AUTHORITY_MATRIX_V1 PROPOSED_FINAL (digest c91868…, price-only scope disclosed, not Human-approved). WP13 MIGRATION_DECISION CONFIRM_REQUIRED_WITH_EXACT_PACKAGE (3 append-only Postgres tables; conviction cardinality Model B cycle-level active/aggregate UNIQUE(org,run,cycle,symbol) + NULLABLE active_hypothesis_record_id + conviction_scope; hypothesis UNIQUE(org,run,cycle,symbol,hypothesis_type); SQLITE_ADAPTER NOT_REQUIRED; migrations 0076–0081; no SQL created). STRATEGY_DISCOVERY_TO_OPERATOR_PROPOSAL_CONTRACT_V1 ratify-token prepared (foundation only; no mature engine in DEE-415). MACRO_E_READINESS READY_FOR_HUMAN_MACRO_E_FINAL_DECISION. Program APPROVED_IDLE. WP13 remains blocked from Build until D-2 resolved, D-3 profile + matrix Human-approved, WP13 migration confirmed, the strategy-discovery contract ratified, the exact HTR-MACRO-E/WP13 packet Human-approved, and Build separately authorized (APPROVE-HTR-INTELLIGENCE-MACRO-E-BUILD). No WP13 build, no code, no SQL, and no PR in this session; single final PR still gated on all 23 WPs."
provenance:
...
> **Macro-E readiness is `READY_FOR_HUMAN_MACRO_E_FINAL_DECISION`** — the final packet is hardened and internally exact. The WP10 evidence-hermeticity correction is **CLOSED `FINAL_PHASE_B_PASS`** (2026-07-14, closeout commit `b132166`; final Opus Phase-B PASS at `521ddd1`). Root cause (historical): a read-only forensic proved the original `pnpm test --run` overwrote the tracked sealed WP10 evidence bundle (`WP10_SEALED_EVIDENCE_MUTATION` + `WP10_TEST_HARNESS_NOT_HERMETIC`). The bounded correction chain — `017fcbe` (FAIL symlink/case-alias), `f2413b2` (FAIL output-directory-substitution TOCTOU), `521ddd1` (PASS cwd/inode-bound child publication + completion contract) — makes the normal suite read/assert-only, adds static path guards + a TOCTOU-safe writer, and accepts a **separate** post-Macro-D compatibility candidate at `replay-runs/RI-P7/htr-wp10-determinism-nolookahead-post-macro-d/` (compatibility artifact `3d3f7cf3…`). The original WP10 seal (`replay-runs/RI-P7/htr-wp10-determinism-nolookahead/`, artifact `fa5def37…`) remains **byte-identical** and was **not** replaced. `LATEST_VALIDATED_PRODUCTION_CODE_SHA` remains `993fdab`; the correction chain touches only the WP10 evidence writer/harness/tests (no production runtime, strategy, risk, market-data, clock/id, or no-lookahead change). Macro E still requires Human final decision on D-2, the D-3 profile + matrix, the WP13 migration (conviction cardinality Model B; SQLITE_ADAPTER NOT_REQUIRED), the strategy-discovery-to-operator foundation contract, and the exact HTR-MACRO-E packet, plus separate Build authorization.
...
WP10 evidence-hermeticity is **RESOLVED_FINAL_PHASE_B_PASS** (closeout `b132166`) — the former `AUTHORIZE-HTR-WP10-EVIDENCE-HERMETICITY-FIX` blocker token is **CONSUMED/CLOSED** and no longer gates Macro E. The six exact tokens **prepared but NOT consumed** for the final Human Macro-E decision:

1. `APPROVE-HTR-D2: venue=HTX market=SPOT symbols=BTCUSDT,ETHUSDT base=1m derived=15m,1h,4h,1d enabled-historical-consumers=liquidity_sweep_reversal_v0,mean_reversion_v0 research-only=trend_momentum_v0 research-only-semantics=EVIDENCE_ONLY_NOT_TRADE_ELIGIBLE strategy-promotion=PROHIBITED edge-verdict=NOT_CLAIMED version-rule=PIN_EXACT_REGISTERED_VERSION_AT_WP16 portfolio=SHARED_MULTI_INSTRUMENT wp13-owns=consumer-set+matrix+terminal-reason+records wp16-owns=version-pin+lifecycle-gating+trial+riskMultiplier`
2. `CLARIFY-HTR-D3-HISTORICAL-PROFILE: profile-id=HTR_HISTORICAL_INTELLIGENCE_PROFILE_V1 profile-digest=9a1ed67e39c2a5e23bb83459f4f1fb52b10c88a49ebbf773b5285c90b82f706c supersedes-draft-digest=fac1a44f… historical-evidence-capability=PRICE_ONLY_GROUNDED_EVIDENCE_PROFILE global-default=PROHIBITED historical-only=YES`
3. `APPROVE-TIMEFRAME-EVIDENCE-LANE-AUTHORITY-MATRIX-V1: matrix-digest=c91868142e8b5ed0b5db533e1811fe4a733290a204efab52f02ed592c1c01b08 fhv-scope-limitation=PRICE_ONLY_GROUNDED_EVIDENCE multi-source-historical-validation=NOT_PERFORMED`
4. `CONFIRM-HTR-MACRO-E-MIGRATION: tables=trader_intelligence_cycle_envelope,trader_intelligence_hypothesis_record,trader_intelligence_conviction_record posture=POSTGRES_ONLY+APPEND_ONLY+SERVICE_ROLE_RLS+ORG_SCOPED sqlite-adapter=NOT_REQUIRED hypothesis-idempotency=UNIQUE(org,run,cycle,symbol,hypothesis_type) conviction-cardinality=MODEL_B_CYCLE_LEVEL_ACTIVE_AGGREGATE conviction-idempotency=UNIQUE(org,run,cycle,symbol) active-hypothesis-link=NULLABLE_COMPOSITE_FK conviction-scope=ACTIVE_HYPOTHESIS|AGGREGATE|NONE migration-files=0076..0081 deferred-to-wp14=forecast,decision,whyNotCash`
...
(full forms in controller §10). **None of these six tokens is consumed in this session.** Build approval remains a **separate later** token `APPROVE-HTR-INTELLIGENCE-MACRO-E-BUILD` — explicitly **not** issued here.
...
**Selected model: Model B (cycle-level active/aggregate conviction).** Model A (per-hypothesis conviction ledger) is rejected because runtime does **not** maintain an independent persisted conviction per hypothesis — only one authoritative active/aggregate conviction per cycle.
...
convictionScope: ACTIVE_HYPOTHESIS | AGGREGATE | NONE            # NOT NULL
...
nullability: active_hypothesis_record_id NULL only when conviction_scope = NONE
...
checkpoint/resume repeats a persisted cycle  -> UNIQUE(org,run,cycle,symbol) => INSERT is idempotent (ON CONFLICT DO NOTHING); byte-identical replay preserved
```
