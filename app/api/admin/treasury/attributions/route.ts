...
export async function GET(request: Request) {
  return runAdminRoute("admin_treasury_attributions", () =>
    handleTreasuryAttributionsGet(request, createProductionAdminRouteDeps()),
  );
}

export async function POST(request: Request) {
  return runAdminRoute("admin_treasury_attributions", () =>
    handleTreasuryAttributionsPost(request, createProductionAdminRouteDeps()),
  );
}
