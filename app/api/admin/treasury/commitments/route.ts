...
export async function GET(request: Request) {
  return runAdminRoute("admin_treasury_commitments", () =>
    handleTreasuryCommitmentsGet(request, createProductionAdminRouteDeps()),
  );
}

export async function POST(request: Request) {
  return runAdminRoute("admin_treasury_commitments", () =>
    handleTreasuryCommitmentsPost(request, createProductionAdminRouteDeps()),
  );
}
