...
export async function GET(request: Request) {
  return runAdminRoute("admin_treasury_runway_plans", () =>
    handleTreasuryRunwayPlansGet(request, createProductionAdminRouteDeps()),
  );
}

export async function POST(request: Request) {
  return runAdminRoute("admin_treasury_runway_plans", () =>
    handleTreasuryRunwayPlansPost(request, createProductionAdminRouteDeps()),
  );
}
