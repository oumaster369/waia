...
/** POST /api/trader/exchange-credentials/[credentialId]/sync-trades — HTX trade history sync (DEE-350). */
export async function POST(
  ...
  try {
    ...
    const telemetryPayload: WaiaRuntimeRouteTelemetryPayload = {
      ...
      route: "trader_exchange_credentials_sync_trades" satisfies WaiaRuntimeRouteKey,
    ...
    emitWaiaRuntimeRouteTelemetry({
      event: "waia_runtime_route",
      route: "trader_exchange_credentials_sync_trades",
      http_status: 500,
