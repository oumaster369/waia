-- DEE-960: additive fenced account observation storage and separate read-only role.
-- Preserves all existing credentials/snapshots; no LOGIN, runtime startup or credential access is granted.
