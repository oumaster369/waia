...
--> statement-breakpoint
CREATE UNIQUE INDEX "payment_addresses_org_subject_active_unique" ON "payment_addresses" USING btree ("organization_id","subject_module","subject_ref") WHERE "status" = 'ACTIVATED';
--> statement-breakpoint
