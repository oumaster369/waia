...
--> statement-breakpoint
CREATE TABLE "trader_runtime_control_leases_v2" (
...
--> statement-breakpoint
CREATE UNIQUE INDEX "trader_runtime_control_leases_v2_org_epoch_unique" ON "trader_runtime_control_leases_v2" ("organization_id","lease_epoch");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TRIGGER "trader_runtime_control_leases_v2_update_guard" BEFORE UPDATE OR DELETE ON "trader_runtime_control_leases_v2" FOR EACH ROW EXECUTE FUNCTION "trader_runtime_authority_v2_append_only_guard"();
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "trader_runtime_control_leases_v2" ENABLE ROW LEVEL SECURITY;
--> statement-breakpoint
ALTER TABLE "trader_runtime_control_leases_v2" FORCE ROW LEVEL SECURITY;
--> statement-breakpoint
CREATE POLICY "trader_runtime_control_leases_v2_deny_direct" ON "trader_runtime_control_leases_v2" AS RESTRICTIVE FOR ALL USING (false) WITH CHECK (false);
