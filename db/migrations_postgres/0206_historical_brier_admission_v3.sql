-- DEE-992 Human-ratified Brier protocol. Supersedes only the WF_PREDICTIVE
-- version predicate; preserves all 0201 organization/request/proposal/Human joins.
-- No old records are changed. Old log-score admissions cannot authorize new writes.
  ...
  WITH CHECK (
    ...
    AND (
      ...
      (
        ...
        AND schema_version='scientific-admission-receipt/v3'
        AND receipt_json::jsonb#>>'{predictiveTerminalReceipt,schemaVersion}'='predictive-terminal-receipt/v2'
        AND receipt_json::jsonb#>>'{predictiveTerminalReceipt,harnessSchemaVersion}'='research-harness-admission/v4'
