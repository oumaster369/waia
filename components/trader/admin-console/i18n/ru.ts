export const RU = {
  ...
  reasons: {
    ...
    INVOICE_EVIDENCE_LIMIT: "Показаны первые 1000 записей каждого вида; история неполная",
    EXPORT_LIMIT: "Выгрузка превышает 50 000 строк или 60 секунд. Сузьте охват или период",
